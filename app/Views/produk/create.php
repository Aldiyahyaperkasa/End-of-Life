                ...
                <div class="container-fluid">
                    <form action="<?= base_url('/produk/store') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="durasi_lisensi" required>
                        </div>
                        <div class="form-group">
                            <label for="nomor_lisensi">Nomor Lisensi:</label>
                            <input type="text" class="form-control" name="nomor_lisensi" required>
                        </div>
                        <div class="form-group">
                            <label for="instalasi_pertama">Instalasi Pertama:</label>
                            <input type="date" class="form-control" name="instalasi_pertama" required>
                        </div>
                        <div class="form-group">
